            ...
            <div class="page-content">
            	<div class="checkout">
	                <div class="container">
            			...
            			<form action="admin/plugin/billing.php" method="post">
		                	<div class="row">
		                		<div class="col-lg-9">
		                ...
		                <input type="text" class="form-control" name="first_name" placeholder="First Name" required>
	            						...
	            						<div class="row">
		                					...
		                					<div class="col-sm-6">
		                						...
		                						<input type="text" name="state"  Placeholder="State/Country" class="form-control" required>
		                					</div><!-- End .col-sm-6 -->
		                				</div><!-- End .row -->
...
<?php
							 $_SESSION['user_id'];
							$cart_query=mysqli_query($conn,"select * from products inner join cart on 
