            	...
            	<div class="checkout">
	                <div class="container">
            			...
            			<form action="admin/plugin/billing.php" method="post">
		                	<div class="row">
		                		<div class="col-lg-9">
		                			<h2 class="checkout-title">Update Profile</h2><!-- End .checkout-title -->
		                				<div class="row">
		                					<div class="col-sm-6">
		                ...
		                <input type="text" class="form-control" name="first_name" required>
											...
											<div class="row">
		   <div class="col-sm-12">             				
<a type="submit" name="billing-btn"
	                			...
	                			<div class="summary summary-cart">
	                				<h3 class="summary-title">My Account</h3><!-- End .summary-title -->
