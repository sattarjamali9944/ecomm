...
<body>
    <div class="page-wrapper">
		...
		require("header_small.php");//this is header file
		
		?>
        <main class="main">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Join <span>Us</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
            ...
            <div class="page-content">
            	<div class="checkout">
	                <div class="container">
            			...
            			<form action="admin/plugin/vendor_registration.php" method="post"
						enctype="multipart/form-data"
						>
		                	<div class="row">
							<div class="col-lg-2"></div>
		                		<div class="col-lg-8">
		                			<h2 class="checkout-title">Join US</h2><!-- End .checkout-title -->
		                				<div class="row">
		                					<div class="col-sm-6">
		                ...
		                <input type="text" class="form-control" name="first_name" placeholder="First Name" required>
	            						...
	            						<input type="text" name="company_name" Placeholder="Company Name" class="form-control">
										 ...
										 <input type="text" name="ntn" class="form-control" Placeholder="You NTN Number">
										 
										 </div>
										 </div>
	            						<label>CNIC*</label>
	            						<input type="text" class="form-control" name="cnic" Placeholder="123465789" required>

	            						<label>Company address / Vendor Address*</label>
	            						<input type="text" name="company_address" class="form-control" placeholder="House number and Street name" required>
	            							<label>Personal address *</label>
										<input type="text" name="personal_address" class="form-control" placeholder="Appartments, suite, unit etc ..." required>
        ...
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
					...
					"border-radius":"100px","float":"left"}).addClass("fa fa-close");
                }
