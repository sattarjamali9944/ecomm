...
<input type="submit" name="city_btn" class="form-control" class="btn btn-primary">	
</form>
</div>

<div class="col-sm-5" style="float:left;">
<?php 
require("delete_city.php");//delete city file 
...
<table class="table table-border">
	...
	?>
		<tr>
			...
			<td><a href="edit_city.php?edit_id=<?php
			echo $city_id;?>" class="btn btn-success">Edit</td>
			<td><a href="add_city.php?del_id=<?php
			echo $city_id;
