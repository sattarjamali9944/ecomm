...
<head>
    ...
    <title>hscode - Bootstrap eCommerce Template</title>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index.html" class="logo">
                            <img src="assets/images/logo.png" alt="hscode Logo" width="105" height="25">
                        </a>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="product-extended.html">Beige knitted elastic runner shoes</a>
                                            </h4>
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            <h4 class="product-title">
                                                <a href="product-extended.html">Blue utility pinafore denim dress</a>
                                            </h4>
...
<?php
							...
							$cart_query=mysqli_query($conn,"select * from products 
							inner join cart on 
							products.pro_id=cart.product_id where
            ...
            <div class="page-content">
            	<div class="cart">
				 ...
				 function id_del(id){
					 ...
					 window.location.href="cart.php?id="+id;// redirect for delete item from cart
                      ...
                      $delete=mysqli_query($conn,"delete from cart where 
					  cart_id='".mysqli_real_escape_string($conn,$_GET['id'])."'") or die(mysqli_error($conn));//delete from cart 
					 	
					 if($delete){			
					
					
					header("location:cart.php?id=Data is successfully Deleted");
							...
							while($fetch_cart_product=mysqli_fetch_array($cart_query)){
								
								
								$product_id=$fetch_cart_product["pro_id"];
								$product_name=$fetch_cart_product["pro_name"];
								$product_price=$fetch_cart_product["pro_price"];
								$product_qty=$fetch_cart_product["qty"];
								
						      $cart_id=$fetch_cart_product["cart_id"];		
...
?>
					 ...
					 <script>
						$(document).ready(function(){
					     ...
					     $("#cart_change<?php echo $product_id;?>").change(function(){	
             						 
						var cart_id=$("#pro_id<?php echo $product_id;?>").val();
					
						var cart_change=$("#cart_change<?php echo  $product_id;?>").val();
        ...
        $.ajax({
            ...
            data: {cart_id:cart_id,cart_change:cart_change},
            dataType: "JSON",
...
window.location.href="cart.php";
					...
					<div id="result<?php echo $product_id;?>"></div>
                        ...
                        <input type="hidden" id="pro_id<?php echo $product_id;?>" 
						value="<?php echo $cart_id;?>">					
                                          <input type="number" class="form-control" 
								value="<?php echo $product_qty;?>" 
								id="cart_change<?php echo  $product_id;?>" min="1" max="99" step="1"
...
?>
											...
											?></td>
											<td class="remove-col"><a href="javascript:id_del(<?php echo $cart_id;?>);"class="btn-remove">
						...
						?>				
	                			...
	                			<div class="cart-bottom">
			            			...
			            			<a href="#" class="btn btn-outline-dark-2"><span>UPDATE CART
...
?> <?php echo $total;?></td>
				...
				<label class="custom-control-label" for="standart-shipping">Free Shipping:</label>
													</div><!-- End .custom-control -->
	                							</td>
	                							<td>
...
?> &nbsp;<?php echo $total+$shipping_price;?></td>
